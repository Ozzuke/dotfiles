...
sudo scutil --set ComputerName "OzzuAir"
sudo scutil --set HostName "OzzuAir"
sudo scutil --set LocalHostName "OzzuAir"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "OzzuAir"
...
# Put the dock on the right side of the screen
